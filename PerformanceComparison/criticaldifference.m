...
elseif alpha == 0.05
% Critical values for the two-tailed Bonferroni-Dunn test
   qalpha = [0.000 1.960 2.241 2.394 2.498 2.576 2.638 2.690 2.724 2.773]; 
...
elseif alpha == 0.1
% Critical values for the two-tailed Bonferroni-Dunn test
   qalpha = [0.000 1.645 1.960 2.128 2.241 2.326 2.394 2.450 2.498 2.539]; 
